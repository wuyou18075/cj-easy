...
```bash
bash <(curl -fsSL "[https://raw.githubusercontent.com/wuyou18075/cj-easy/refs/heads/main/docker-manager.sh?v=$](https://raw.githubusercontent.com/wuyou18075/cj-easy/refs/heads/main/docker-manager.sh?v=$)(date +%s)")
```
