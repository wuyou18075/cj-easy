cd /root && mkdir -p tg_vps_bot && cd tg_vps_bot

# 1. 下载你的 GitHub 源码保存为正确的 Python 主程序
curl -fsSL "https://raw.githubusercontent.com/wuyou18075/cj-easy/refs/heads/main/vps-tg-bot-install.sh?v=$(date +%s)" -o main.py
